...
public class CreateEnvironment {
	...
	static Thread t = new Thread("waiting...");
	...
	private static void initializePlayer() {
		...
		player1.welcome();
			...
			System.out.println("name entered was wrong please re enter");
		}
	...
	private static void showLeaderBoard() {
		...
		for (int i = 0; i < leaders.size(); i++) {
			Player topper = leaders.get(i);
			System.out.println(topper.playerName + "\t\t\t" + topper.score + "\t\t\t" + topper.timeTaken);
	...
	static void createRoom1() {
		String walls[] = {
				"the world is chaotic but not me," + "I follow instructions to the dot cause i am the Royal Prince"
						+ "\nthe son of Tipu sultan,I always start at THE CENTER OF THE WORLD",
				"boolean number=command ,boolean number*=reverse(command)",
				"1.1 step right\n" + "2*.1 step down\n" + "3*.2 steps right\n" + "4.2 steps down\n" + "5*.1 step left",
				"2 5 4\n" + "1 3 8\n" + "6 9 7" };
		r1 = new Room("Prince's Room", walls,
				...
				false, "8 4 2 6 9", "grey", 1);
	}

	static void createRoom2() {
		String walls[] = { "I bubble I giggle with colors I mingle" + "\n,and balls i like to play with.",
		...
		r2 = new Room("Princess' Room", walls, "help the princess find the product of this puzzle", false, "11880",
				"pink", 2);
	}

	static void createRoom3() {
		String walls[] = {
				"The king loves his kingdom, and I love him for he brings"
		...
		r3 = new Room("Queen' Room", walls,
				"can you help the queen arrange the lovely deers keep in mind that she prefers them young", false,
				"1 4 3 2 5", "red", 3);
	}

	static void createRoom4() {
		String walls[] = { "The royal family is fond of food." + "Along with this they like praising their cutlery.",
		...
		r4 = new Room("Royal Kitchen", walls,
				...
				false, "0 1 0 1 0", "blue", 4);
	}

	static void createRoom5() {
		String walls[] = { "", "", "", "" };
		r5 = new Room("Royal Meeting Room", walls,
				"The king is ferocious as to how did someone dare to enter the princess' room. He is a man"
				...
				false, "4 4 3 4 0", "Silver", 5);
	}

	static void createMaster() {
		String walls[] = { "The only people who come here now how to fill up gaps.",
		...
		mr = new MasterRoom("The King's Room", walls,
